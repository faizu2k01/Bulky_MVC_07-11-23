    ...
    public partial class initilizedb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "CategoryId", "DisplayName", "Name" },
                values: new object[,]
                {
                    { 1, 1, "Action" },
                    { 2, 2, "Sci-Fi" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Shahganj", "Blue stone", 87974844L, "89789", "UP", "Purani bajar shahganj" },
                    { 2, "Shahganj", "Brown stone", 87974844L, "89789", "UP", "Purani bajar shahganj" }
                });
